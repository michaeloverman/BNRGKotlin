...
object RandomGame2048Initializer: Game2048Initializer<Int> {
    ...
    override fun nextValue(board: GameBoard<Int?>): Pair<Cell, Int>? {
        val possibleCells = board.filter { it == null }
//        println("Possible: $possibleCells")
        return if (possibleCells.isEmpty()) null
        else Pair(possibleCells.shuffled().first(), generateRandomStartValue())
//        val r = generateRandomStartValue()
//        println("Random: $r")
//        val c = possibleCells.shuffled().first()
//        println("Cell: $c")
//        return Pair(c, r)
